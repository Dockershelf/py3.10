...
Debian packaging for CPython 3.10: patches, `debiandirs/`, and changelog tracks used by the [Dockershelf python-pipeline](https://github.com/Dockershelf/python-pipeline).
...
make build PY=3.10 DIST=trixie
```
